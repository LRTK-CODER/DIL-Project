...
class Suppression(DataSetting):
    ...
    def partial(self, column: str, scope: list):
        ...
        Args:
            column (str) : 부분 삭제를 적용할 컬럼
            scope (list) : 데이터의 부분 삭제 적용 범위 지정
    ...
    def record(self, currentIndexList: list):
        ...
        Args:
            currentIndexList (list) : 삭제 할 Index list
    ...
    def local(self, column: str, currentIndexList: list):
        ...
        Args:
            column (str) : 로컬 삭제 기술을 적용할 컬럼
            currentIndexList (list) : 로컬 삭제 기술을 적용할 Index list
    ...
    def masking(self, column: str, scope: list):
        ...
        Args:
            column (str) : 마스킹 기술을 적용할 컬럼
            scope (list) : 데이터에 마스킹 기술을 적용할 범위 지정
